...
```
使用 img_gen skill 生成参考图:
1. 场景参考图 → assets/scenes/ch1/
2. 角色参考图 → assets/characters/

Prompt模板已写入各设定文档，直接读取使用即可。
```
...
> 每个场景一个文档，包含环境描述、参考图Prompt等

#### 第一章场景 (`scenes/ch1/`)

| 文档 | 状态 | 说明 |
|------|------|------|
| [SC-001 神秘房间](./scenes/ch1/sc_001_神秘房间.md) | ✅ 完成 | 主角醒来的起始场景 |
| [SC-002 探索后房间](./scenes/ch1/sc_002_探索后房间.md) | ✅ 完成 | 探索后的状态变化 |
