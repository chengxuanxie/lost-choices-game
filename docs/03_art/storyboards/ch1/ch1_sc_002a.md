...
video_path: res://assets/videos/ch1/sc002a_meet_lin.ogv
node_id: ch1_sc_002a
...
| 时间 | 画面 | POV | 动作 | 情绪 |
|------|------|-----|------|------|
| 0-45s | 场景环境展示 | 第一人称 | 观察 | 警觉 |
| 45-90s | 角色互动 | 第一人称 | 对话/行动 | 紧张 |

**AI Prompt**:
```
First person POV, 废弃仓库, abandoned atmosphere,
cinematic, dramatic lighting, slow natural movement, 4K, 16:9 --duration 90
```

---

### Segment 2: 发展 (90-180秒)

| 时间 | 画面 | POV | 动作 | 情绪 |
|------|------|-----|------|------|
| 90-135s | 剧情推进 | 第一人称 | 互动 | 专注 |
| 135-180s | 信息揭示 | 第一人称 | 反应 | 惊讶 |

**AI Prompt**:
```
First person POV, story development scene, character interaction,
abandoned mood, cinematic, 4K, 16:9 --duration 90
```

---

### Segment 3: 高潮/过渡 (180-360秒)

| 时间 | 画面 | POV | 动作 | 情绪 |
|------|------|-----|------|------|
| 180-270s | 关键时刻 | 第一人称 | 决策 | 紧张 |
| 270-360s | 过渡/准备选择 | 第一人称 | 等待 | 期待 |

**AI Prompt**:
```
First person POV, climax moment, decision point,
abandoned intensity, cinematic tension, 4K, 16:9 --duration 180
```
