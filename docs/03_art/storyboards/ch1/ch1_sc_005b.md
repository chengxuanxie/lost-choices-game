...
video_path: res://assets/videos/ch1/sc005b_bai_offer.ogv
node_id: ch1_sc_005b
...
**AI Prompt**:
```
First person POV, 书店, quiet mystery atmosphere,
...
quiet mystery mood, cinematic, 4K, 16:9 --duration 75
```
...
quiet mystery intensity, cinematic tension, 4K, 16:9 --duration 150
```
...
### 主Prompt模板
```
First person POV, cinematic, 书店,
quiet mystery atmosphere, dramatic lighting,
natural head movement, film grain, 4K, 16:9
```

### 风格词库
```
Positive: cinematic, first person POV, quiet mystery,
