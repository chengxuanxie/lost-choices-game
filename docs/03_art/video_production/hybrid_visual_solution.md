...
**即梦AI 是中文模型，必须使用中文提示词！**

| 错误示范 | 正确示范 |
|----------|----------|
| `First person POV, waking up...` | `第一人称视角，醒来时的画面...` |
| `cinematic, mysterious atmosphere` | `电影感画面，神秘氛围` |

**关键帧提示词模板**:
```
第一人称视角，电影感画面，[场景描述]，[动作/状态]，冷蓝色调环境光，暖金色点缀，神秘氛围，4K高清
```

**图生图必须使用参考图**:
```
--images "https://lost-choices-art.tos-cn-beijing.volces.com/scenes/ch1/sc_001/sc_001_env_01.png"
```
...
> **重要**: 本方案已验证可行，平衡了视觉效果与制作效率

### 3.0 场景图+人物参考图方案

**核心思路**: 使用已有的场景图和人物参考图代替逐帧关键帧

| 资产类型 | 用途 | 替代方案 |
|----------|------|----------|
| 场景参考图 | 背景环境 | 已有各场景1张首帧图 |
| 人物参考图 | 角色形象 | 已有各角色多张参考图 |
| 关键帧序列 | 动作/表情变化 | 用视频动态表现 |
...
**适用场景**:
- 已有完整视频的场景（SC-001~SC-008）
- 需要快速完成的过渡场景

**当前状态**:
```
关键帧: SC-001 20张完整, 其他场景各1张
